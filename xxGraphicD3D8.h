...
//  Swapchain
//==============================================================================
xxAPI uint64_t      xxCreateSwapchainD3D8(uint64_t device, uint64_t renderPass, void* view, unsigned int width, unsigned int height, uint64_t oldSwapchain);
...
xxAPI uint64_t      xxCreateVertexBufferD3D8(uint64_t device, unsigned int size, uint64_t vertexAttribute);
...
//  Texture
//==============================================================================
xxAPI uint64_t      xxCreateTextureD3D8(uint64_t device, int format, unsigned int width, unsigned int height, unsigned int depth, unsigned int mipmap, unsigned int array, const void* external);
xxAPI void          xxDestroyTextureD3D8(uint64_t texture);
xxAPI void*         xxMapTextureD3D8(uint64_t device, uint64_t texture, unsigned int* stride, unsigned int level, unsigned int array);
xxAPI void          xxUnmapTextureD3D8(uint64_t device, uint64_t texture, unsigned int level, unsigned int array);
//==============================================================================
//  Sampler
//==============================================================================
...
xxAPI void          xxSetVertexConstantBufferD3D8(uint64_t commandEncoder, uint64_t buffer, unsigned int size);
xxAPI void          xxSetFragmentConstantBufferD3D8(uint64_t commandEncoder, uint64_t buffer, unsigned int size);
