...
//  Sampler
//==============================================================================
xxAPI uint64_t      xxCreateSamplerD3D9(uint64_t device, bool linearMag, bool linearMin, bool linearMip);
...
xxAPI uint64_t      xxCreatePipelineD3D9(uint64_t device, uint64_t blendState, uint64_t depthStencilState, uint64_t rasterizerState, uint64_t vertexAttribute, uint64_t vertexShader, uint64_t fragmentShader);
...
xxAPI void          xxSetPipelineD3D9(uint64_t commandBuffer, uint64_t pipeline);
xxAPI void          xxSetIndexBufferD3D9(uint64_t commandBuffer, uint64_t buffer);
xxAPI void          xxSetVertexBuffersD3D9(uint64_t commandBuffer, int count, const uint64_t* buffers, uint64_t vertexAttribute);
...
xxAPI void          xxSetVertexSamplersD3D9(uint64_t commandBuffer, int count, const uint64_t* samplers);
xxAPI void          xxSetFragmentSamplersD3D9(uint64_t commandBuffer, int count, const uint64_t* samplers);
