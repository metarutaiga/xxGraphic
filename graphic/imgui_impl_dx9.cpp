...
bool ImGui_ImplDX9_Create(void* hWnd)
{
    ...
    if (g_pD3D->CreateDevice(D3DADAPTER_DEFAULT, D3DDEVTYPE_HAL, (HWND)hWnd, D3DCREATE_HARDWARE_VERTEXPROCESSING, &g_d3dpp, &g_pd3dDevice) < 0)
        return false;

    return true;
}

bool ImGui_ImplDX9_Cleanup()
{
    if (g_pd3dDevice) { g_pd3dDevice->Release(); g_pd3dDevice = NULL; }
...
bool ImGui_ImplDX9_Clear(const ImVec4& clear_color)
{
...
bool ImGui_ImplDX9_Finish()
{
    g_pd3dDevice->EndScene();
    return true;
}

bool ImGui_ImplDX9_Present()
{
