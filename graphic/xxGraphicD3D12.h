...
//  Render Pass
//==============================================================================
xxAPI uint64_t      xxCreateRenderPassD3D12(uint64_t device, bool clearColor, bool clearDepth, bool clearStencil, bool storeClear, bool storeDepth, bool storeStencil);
xxAPI void          xxDestroyRenderPassD3D12(uint64_t renderPass);
xxAPI uint64_t      xxBeginRenderPassD3D12(uint64_t commandBuffer, uint64_t framebuffer, uint64_t renderPass, float r, float g, float b, float a, float depth, unsigned char stencil);
...
xxAPI void          xxSetIndexBufferD3D12(uint64_t commandEncoder, uint64_t buffer);
...
//  Fixed-Function
//==============================================================================
xxAPI void          xxSetTransformD3D12(uint64_t commandEncoder, const float* world, const float* view, const float* projection);
