...
const GR_HANDLE GR_NULL_HANDLE = 0;
...
typedef GR_RESULT (GR_STDCALL *PFN_grDbgRegisterMsgCallback)(GR_DBG_MSG_CALLBACK_FUNCTION pfnMsgCallback, GR_VOID* pUserData);
...
#if GR_PROTOTYPES
PFN_grDbgRegisterMsgCallback grDbgRegisterMsgCallback;
