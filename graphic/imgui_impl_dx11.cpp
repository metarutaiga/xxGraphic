...
bool ImGui_ImplDX11_Begin()
{
    g_pd3dDeviceContext->OMSetRenderTargets(1, &g_mainRenderTargetView, NULL);
    return true;
}

bool ImGui_ImplDX11_Clear(const ImVec4& clear_color)
{
    g_pd3dDeviceContext->ClearRenderTargetView(g_mainRenderTargetView, (float*)&clear_color);
    return true;
}

bool ImGui_ImplDX11_Finish()
{
    return true;
}

bool ImGui_ImplDX11_Present()
{
