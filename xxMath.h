...
union xxCPPAPI xxVector2
{
    ...
    xxVector2       operator -  () const                     { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] = -t.f[i];              return t;       }
    xxVector2&      operator += (const xxVector2& v)         { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] += v.f[i]; (*this) = t; return (*this); }
    xxVector2&      operator -= (const xxVector2& v)         { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] -= v.f[i]; (*this) = t; return (*this); }
    xxVector2&      operator *= (const xxVector2& v)         { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] *= v.f[i]; (*this) = t; return (*this); }
    xxVector2&      operator /= (const xxVector2& v)         { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] /= v.f[i]; (*this) = t; return (*this); }
    xxVector2&      operator *= (float s)                    { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] *= s;      (*this) = t; return (*this); }
...
union xxCPPAPI xxVector3
{
    ...
    xxVector3       operator -  () const                     { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] = -t.f[i];              return t;       }
    xxVector3&      operator += (const xxVector3& v)         { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] += v.f[i]; (*this) = t; return (*this); }
    xxVector3&      operator -= (const xxVector3& v)         { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] -= v.f[i]; (*this) = t; return (*this); }
    xxVector3&      operator *= (const xxVector3& v)         { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] *= v.f[i]; (*this) = t; return (*this); }
    xxVector3&      operator /= (const xxVector3& v)         { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] /= v.f[i]; (*this) = t; return (*this); }
    xxVector3&      operator *= (float s)                    { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] *= s;      (*this) = t; return (*this); }
...
union xxCPPAPI xxVector4
{
    ...
    xxVector4       operator -  () const                     { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] = -t.f[i];              return t;       }
    xxVector4&      operator += (const xxVector4& v)         { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] += v.f[i]; (*this) = t; return (*this); }
    xxVector4&      operator -= (const xxVector4& v)         { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] -= v.f[i]; (*this) = t; return (*this); }
    xxVector4&      operator *= (const xxVector4& v)         { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] *= v.f[i]; (*this) = t; return (*this); }
    xxVector4&      operator /= (const xxVector4& v)         { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] /= v.f[i]; (*this) = t; return (*this); }
    xxVector4&      operator *= (float s)                    { auto t(*this); for (int i = 0; i < N; ++i) t.f[i] *= s;      (*this) = t; return (*this); }
...
union xxCPPAPI xxMatrix2x2
{
    ...
    xxMatrix2x2     operator -  () const                     { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] = -t.f[i];              return t;       }
    xxMatrix2x2&    operator += (const xxMatrix2x2& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] += m.f[i]; (*this) = t; return (*this); }
    xxMatrix2x2&    operator -= (const xxMatrix2x2& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] -= m.f[i]; (*this) = t; return (*this); }
    xxMatrix2x2&    operator *= (float s)                    { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] *= s;      (*this) = t; return (*this); }
    xxMatrix2x2&    operator /= (float s)                    { (*this) *= (1.0f / s);                                                        return (*this); }

    xxVector2       operator *  (const xxVector2& v) const   { xxVector2 t;   t = _[0] * v.x + _[1] * v.y;    return t; }
    xxMatrix2x2     operator *  (const xxMatrix2x2& m) const { auto t(*this); t = { t * m._[0], t * m._[1] }; return t; }
...
union xxCPPAPI xxMatrix2x3
{
    ...
    xxMatrix2x3     operator -  () const                     { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] = -t.f[i];              return t;       }
    xxMatrix2x3&    operator += (const xxMatrix2x3& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] += m.f[i]; (*this) = t; return (*this); }
    xxMatrix2x3&    operator -= (const xxMatrix2x3& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] -= m.f[i]; (*this) = t; return (*this); }
    xxMatrix2x3&    operator *= (float s)                    { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] *= s;      (*this) = t; return (*this); }
...
union xxCPPAPI xxMatrix2x4
{
    ...
    xxMatrix2x4     operator -  () const                     { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] = -t.f[i];              return t;       }
    xxMatrix2x4&    operator += (const xxMatrix2x4& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] += m.f[i]; (*this) = t; return (*this); }
    xxMatrix2x4&    operator -= (const xxMatrix2x4& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] -= m.f[i]; (*this) = t; return (*this); }
    xxMatrix2x4&    operator *= (float s)                    { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] *= s;      (*this) = t; return (*this); }
...
union xxCPPAPI xxMatrix3x2
{
    ...
    xxMatrix3x2     operator -  () const                     { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] = -t.f[i];              return t;       }
    xxMatrix3x2&    operator += (const xxMatrix3x2& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] += m.f[i]; (*this) = t; return (*this); }
    xxMatrix3x2&    operator -= (const xxMatrix3x2& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] -= m.f[i]; (*this) = t; return (*this); }
    xxMatrix3x2&    operator *= (float s)                    { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] *= s;      (*this) = t; return (*this); }
...
union xxCPPAPI xxMatrix3x3
{
    ...
    xxMatrix3x3     operator -  () const                     { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] = -t.f[i];              return t;       }
    xxMatrix3x3&    operator += (const xxMatrix3x3& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] += m.f[i]; (*this) = t; return (*this); }
    xxMatrix3x3&    operator -= (const xxMatrix3x3& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] -= m.f[i]; (*this) = t; return (*this); }
    xxMatrix3x3&    operator *= (float s)                    { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] *= s;      (*this) = t; return (*this); }
    xxMatrix3x3&    operator /= (float s)                    { (*this) *= (1.0f / s);                                                        return (*this); }

    xxVector3       operator *  (const xxVector3& v) const   { xxVector3 t;   t = _[0] * v.x + _[1] * v.y + _[2] * v.z;   return t; }
    xxMatrix3x3     operator *  (const xxMatrix3x3& m) const { auto t(*this); t = { t * m._[0], t * m._[1], t * m._[2] }; return t; }
...
union xxCPPAPI xxMatrix3x4
{
    ...
    xxMatrix3x4     operator -  () const                     { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] = -t.f[i];              return t;       }
    xxMatrix3x4&    operator += (const xxMatrix3x4& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] += m.f[i]; (*this) = t; return (*this); }
    xxMatrix3x4&    operator -= (const xxMatrix3x4& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] -= m.f[i]; (*this) = t; return (*this); }
    xxMatrix3x4&    operator *= (float s)                    { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] *= s;      (*this) = t; return (*this); }
...
union xxCPPAPI xxMatrix4x2
{
    ...
    xxMatrix4x2     operator -  () const                     { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] = -t.f[i];              return t;       }
    xxMatrix4x2&    operator += (const xxMatrix4x2& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] += m.f[i]; (*this) = t; return (*this); }
    xxMatrix4x2&    operator -= (const xxMatrix4x2& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] -= m.f[i]; (*this) = t; return (*this); }
    xxMatrix4x2&    operator *= (float s)                    { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] *= s;      (*this) = t; return (*this); }
...
union xxCPPAPI xxMatrix4x3
{
    ...
    xxMatrix4x3     operator -  () const                     { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] = -t.f[i];              return t;       }
    xxMatrix4x3&    operator += (const xxMatrix4x3& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] += m.f[i]; (*this) = t; return (*this); }
    xxMatrix4x3&    operator -= (const xxMatrix4x3& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] -= m.f[i]; (*this) = t; return (*this); }
    xxMatrix4x3&    operator *= (float s)                    { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] *= s;      (*this) = t; return (*this); }
...
union xxCPPAPI xxMatrix4x4
{
    ...
    xxMatrix4x4     operator -  () const                     { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] = -t.f[i];              return t;       }
    xxMatrix4x4&    operator += (const xxMatrix4x4& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] += m.f[i]; (*this) = t; return (*this); }
    xxMatrix4x4&    operator -= (const xxMatrix4x4& m)       { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] -= m.f[i]; (*this) = t; return (*this); }
    xxMatrix4x4&    operator *= (float s)                    { auto t(*this); for (int i = 0; i < M * N; ++i) t.f[i] *= s;      (*this) = t; return (*this); }
    xxMatrix4x4&    operator /= (float s)                    { (*this) *= (1.0f / s);                                                        return (*this); }

    xxVector4       operator *  (const xxVector4& v) const   { xxVector4 t;   t = _[0] * v.x + _[1] * v.y + _[2] * v.z + _[3] * v.w;  return t; }
    xxMatrix4x4     operator *  (const xxMatrix4x4& m) const { auto t(*this); t = { t * m._[0], t * m._[1], t * m._[2], t * m._[3] }; return t; }
    ...
    static void MultiplyArray(const xxMatrix4& matrix, size_t count, const xxVector4* input, int inputStride, xxVector4* output, int outputStride);
    static void MultiplyArray(const xxMatrix4& matrix, size_t count, const xxMatrix4* input, int inputStride, xxMatrix4* output, int outputStride);
