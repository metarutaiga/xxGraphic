...
#if GR_PROTOTYPES
PFN_grInitAndEnumerateGpus          grInitAndEnumerateGpus;
PFN_grGetGpuInfo                    grGetGpuInfo;
PFN_grCreateDevice                  grCreateDevice;
PFN_grDestroyDevice                 grDestroyDevice;
PFN_grGetExtensionSupport           grGetExtensionSupport;
PFN_grGetDeviceQueue                grGetDeviceQueue;
PFN_grQueueWaitIdle                 grQueueWaitIdle;
PFN_grDeviceWaitIdle                grDeviceWaitIdle;
PFN_grQueueSubmit                   grQueueSubmit;
PFN_grQueueSetGlobalMemReferences   grQueueSetGlobalMemReferences;
PFN_grGetMemoryHeapCount            grGetMemoryHeapCount;
PFN_grGetMemoryHeapInfo             grGetMemoryHeapInfo;
PFN_grAllocMemory                   grAllocMemory;
PFN_grFreeMemory                    grFreeMemory;
PFN_grSetMemoryPriority             grSetMemoryPriority;
PFN_grMapMemory                     grMapMemory;
PFN_grUnmapMemory                   grUnmapMemory;
PFN_grRemapVirtualMemoryPages       grRemapVirtualMemoryPages;
PFN_grPinSystemMemory               grPinSystemMemory;
PFN_grDestroyObject                 grDestroyObject;
PFN_grGetObjectInfo                 grGetObjectInfo;
PFN_grBindObjectMemory              grBindObjectMemory;
PFN_grGetFormatInfo                 grGetFormatInfo;
PFN_grCreateImage                   grCreateImage;
PFN_grGetImageSubresourceInfo       grGetImageSubresourceInfo;
PFN_grCreateSampler                 grCreateSampler;
PFN_grCreateImageView               grCreateImageView;
PFN_grCreateColorTargetView         grCreateColorTargetView;
PFN_grCreateShader                  grCreateShader;
PFN_grCreateGraphicsPipeline        grCreateGraphicsPipeline;
PFN_grCreateComputePipeline         grCreateComputePipeline;
PFN_grStorePipeline                 grStorePipeline;
PFN_grLoadPipeline                  grLoadPipeline;
PFN_grCreateDescriptorSet           grCreateDescriptorSet;
PFN_grBeginDescriptorSetUpdate      grBeginDescriptorSetUpdate;
PFN_grEndDescriptorSetUpdate        grEndDescriptorSetUpdate;
PFN_grAttachSamplerDescriptors      grAttachSamplerDescriptors;
PFN_grAttachImageViewDescriptors    grAttachImageViewDescriptors;
PFN_grAttachMemoryViewDescriptors   grAttachMemoryViewDescriptors;
PFN_grAttachNestedDescriptors       grAttachNestedDescriptors;
PFN_grClearDescriptorSetSlots       grClearDescriptorSetSlots;
PFN_grCreateViewportState           grCreateViewportState;
PFN_grCreateRasterState             grCreateRasterState;
PFN_grCreateColorBlendState         grCreateColorBlendState;
PFN_grCreateDepthStencilState       grCreateDepthStencilState;
PFN_grCreateMsaaState               grCreateMsaaState;
PFN_grCreateQueryPool               grCreateQueryPool;
PFN_grGetQueryPoolResults           grGetQueryPoolResults;
PFN_grCreateFence                   grCreateFence;
PFN_grGetFenceStatus                grGetFenceStatus;
PFN_grWaitForFences                 grWaitForFences;
PFN_grCreateQueueSemaphore          grCreateQueueSemaphore;
PFN_grSignalQueueSemaphore          grSignalQueueSemaphore;
PFN_grWaitQueueSemaphore            grWaitQueueSemaphore;
PFN_grCreateEvent                   grCreateEvent;
PFN_grGetEventStatus                grGetEventStatus;
PFN_grSetEvent                      grSetEvent;
PFN_grResetEvent                    grResetEvent;
PFN_grGetMultiGpuCompatibility      grGetMultiGpuCompatibility;
PFN_grOpenSharedMemory              grOpenSharedMemory;
PFN_grOpenSharedQueueSemaphore      grOpenSharedQueueSemaphore;
PFN_grOpenPeerMemory                grOpenPeerMemory;
PFN_grOpenPeerImage                 grOpenPeerImage;
PFN_grCreateCommandBuffer           grCreateCommandBuffer;
PFN_grBeginCommandBuffer            grBeginCommandBuffer;
PFN_grEndCommandBuffer              grEndCommandBuffer;
PFN_grResetCommandBuffer            grResetCommandBuffer;
PFN_grCmdBindPipeline               grCmdBindPipeline;
PFN_grCmdBindStateObject            grCmdBindStateObject;
PFN_grCmdBindDescriptorSet          grCmdBindDescriptorSet;
PFN_grCmdBindDynamicMemoryView      grCmdBindDynamicMemoryView;
PFN_grCmdBindIndexData              grCmdBindIndexData;
PFN_grCmdBindTargets                grCmdBindTargets;
PFN_grCmdPrepareMemoryRegions       grCmdPrepareMemoryRegions;
PFN_grCmdPrepareImages              grCmdPrepareImages;
PFN_grCmdDraw                       grCmdDraw;
PFN_grCmdDrawIndexed                grCmdDrawIndexed;
PFN_grCmdDrawIndirect               grCmdDrawIndirect;
PFN_grCmdDrawIndexedIndirect        grCmdDrawIndexedIndirect;
PFN_grCmdDispatch                   grCmdDispatch;
PFN_grCmdDispatchIndirect           grCmdDispatchIndirect;
PFN_grCmdCopyMemory                 grCmdCopyMemory;
PFN_grCmdCopyImage                  grCmdCopyImage;
PFN_grCmdCopyMemoryToImage          grCmdCopyMemoryToImage;
PFN_grCmdCopyImageToMemory          grCmdCopyImageToMemory;
PFN_grCmdResolveImage               grCmdResolveImage;
PFN_grCmdCloneImageData             grCmdCloneImageData;
PFN_grCmdUpdateMemory               grCmdUpdateMemory;
PFN_grCmdFillMemory                 grCmdFillMemory;
PFN_grCmdClearColorImage            grCmdClearColorImage;
PFN_grCmdClearColorImageRaw         grCmdClearColorImageRaw;
PFN_grCmdClearDepthStencil          grCmdClearDepthStencil;
PFN_grCmdSetEvent                   grCmdSetEvent;
PFN_grCmdResetEvent                 grCmdResetEvent;
PFN_grCmdMemoryAtomic               grCmdMemoryAtomic;
PFN_grCmdBeginQuery                 grCmdBeginQuery;
PFN_grCmdEndQuery                   grCmdEndQuery;
PFN_grCmdResetQueryPool             grCmdResetQueryPool;
PFN_grCmdWriteTimestamp             grCmdWriteTimestamp;
PFN_grCmdInitAtomicCounters         grCmdInitAtomicCounters;
PFN_grCmdLoadAtomicCounters         grCmdLoadAtomicCounters;
PFN_grCmdSaveAtomicCounters         grCmdSaveAtomicCounters;
#endif
